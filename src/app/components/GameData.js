...
const gameData = {
  ...
  "endings": [
    ...
    {
      "id": "A_minus_perfectionist", "name": "완벽했지만 너무 느렸던 밤", "condition": "sec >= 5 && evid >= 6 && trust >= 4 && downtime > 45",
      "summary": "당신이 제출한 보고서는 한 편의 교과서였습니다. 하지만 그 완벽한 보고서가 완성될 동안 회사의 핵심 서비스는 한 시간 가까이 멈춰있었습니다. 회사는 안전해졌지만 막대한 기회비용을 치렀습니다. 당신은 최고의 기술자이지만, 위기 상황의 압박 속에서 빠르게 움직여야 할 때는 약점을 보인다는 평가를 받습니다."
    },
    {
    ...
    {
      "id": "B1", "name": "흔적이 남고 신뢰가 흔들린 밤", "condition": "!(A1||S1_detective||A_minus_perfectionist||A2||B_plus_pragmatist||B2||C)",
